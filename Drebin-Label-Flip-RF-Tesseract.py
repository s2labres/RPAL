...
'''
Drebin using Random Forest 2014-2018 Experiment
...
def run_exp(poisoning_strength, al_strength, splits, random_state):
    ...
    # Perform evaluation
    print("Evaluating....")
    clf = RandomForestClassifier(max_depth=64,
                                 n_estimators=101,
    ...
    with open("Results/Data/Drebin-Label-Flip-RF-Tesseract/Drebin-Label-Flip-RF-Tesseract-AL" + al_strength
